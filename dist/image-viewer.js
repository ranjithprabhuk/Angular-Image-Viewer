...
angular.module('imageViewer',[]).directive('imageViewer',function(){
     ...
     return {
         ...
         template:'<div style="padding:10px;">\
                <button id="girardir" class="btn btn-primary btn-sm" ng-disabled="noImage"><span class="fa fa-rotate-left"> </span> Rotate to Left</button>\
                <button id="giraresq" class="btn btn-primary btn-sm" ng-disabled="noImage"><span class="fa fa-rotate-right"> </span> Rotate to Right</button>\
                <button id="zoomIn" class="btn btn-info btn-sm" ng-disabled="noImage"><span class="fa fa-plus"> </span> Zoom</button>\
                <button id="zoomOut" class="btn btn-info btn-sm" ng-disabled="noImage"><span class="fa fa-minus"> </span> Zoom</button>\
                <button id="carregar" class="btn btn-warning btn-sm" ng-disabled="noImage"><span class="fa fa-arrow-left"> </span> Reset</button>\
                <button id="close" class="btn btn-danger btn-sm pull-right"><span class="fa fa-close"> </span> Close</button>\
                </div>\
...
angular.element('#close').click(function () {
    scope.closeCanvas();
   //clear();
});
